...
public class NumberActivity extends ListActivity implements TextWatcher {
    ...
    SongDBNumberArrayAdapter<SongDBEntry> adapter;
...
//    }
    ...
    public void onCreate(Bundle state) {
        ...
        if (midiSonglist != null) {
            adapter = new SongDBNumberArrayAdapter<SongDBEntry>(this, android.R.layout.simple_list_item_1, midiSonglist);
...
//        }
    ...
    void loadAssetMidiFiles() {
        ...
        ArrayList<SongDBEntry> dbSonglist = myDBHelper.listSongsByNumber();
