 ...
 */
public class SongDBLyricArrayAdapter<T> extends ArrayAdapter<T> {
    ...
    public SongDBLyricArrayAdapter(Context context, int resourceId, ArrayList<SongDBEntry> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        text.setText(createIndentedText(songTitle, 0, 18));
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if (constraint != null && constraint.toString().length() > 0) {
                ...
                for (int i = 0, l = lItems.size(); i < l; i++) {
                    ...
                    if (m.getLyrics() != null) {
                        if (m.getLyrics().toLowerCase().contains(constraint))
                            filt.add(m);
                    }
                }
