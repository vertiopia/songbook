 ...
 */
public class MidiPlayer extends RelativeLayout {
    ...
    static Bitmap keyUpImage;         /** The Key Up image */
    static Bitmap keyDownImage;       /** The Key Down image */
    ...
    private ImageButton pauseButton;    /** The Pause Button */
    ...
    private ImageButton keyUpButton;  /** Key Up button */
    private ImageButton keyDownButton;    /** Key Down button */
    private TextView keyText;         /** The Key label */
    ...
    public static void LoadImages(Context context) {
        ...
        keyUpImage = BitmapFactory.decodeResource(res, R.drawable.plus);
        keyDownImage = BitmapFactory.decodeResource(res, R.drawable.minus);
...
//        this.addView(stopButton);
        ...
        playButton.setId(1002);
        playButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
//                if ((playstate == paused) || (playstate == stopped) || (playstate == initPause) || (playstate == initStop)) {
//                    Play();
//                    playButton.setImageBitmap(pauseImage);
//                } else {
//                    Pause();
//                    playButton.setImageBitmap(playImage);
//                }
...
//        this.addView(playButton);
        ...
        pauseButton = new ImageButton(activity);
...
//        this.addView(pauseButton);
        ...
        /* Create the Key bar */
        keyText = new TextView(activity);
        //keyText.setText("  Key: 00 ");
        keyText.setText("  Key: +0  ");
        keyText.setId(1004);
...
//        this.addView(keyText);
        ...
        /* Create the tempo up button */
        keyUpButton = new ImageButton(activity);
        keyUpButton.setBackgroundColor(Color.BLACK);
        keyUpButton.setImageBitmap(keyUpImage);
        keyUpButton.setScaleType(ImageView.ScaleType.FIT_XY);
        keyUpButton.setId(1005);
        keyUpButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                KeyUp();
            }
        });
//        this.addView(keyUpButton);

        /* Create the tempo down button */
        keyDownButton = new ImageButton(activity);
        keyDownButton.setBackgroundColor(Color.BLACK);
        keyDownButton.setImageBitmap(keyDownImage);
        keyDownButton.setScaleType(ImageView.ScaleType.FIT_XY);
        keyDownButton.setId(1006);
        keyDownButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                KeyDown();
            }
        });
//        this.addView(keyDownButton);

        /* Create the Speed bar */
        speedText = new TextView(activity);
//        speedText.setText(" Speed: 100%   ");
        speedText.setText(" Speed: 100%  ");
        speedText.setId(1007);
...
//                speedText.setText(" Speed: " + String.format(Locale.US, "%.1f", (float)progress/100) + "  ");
            }
...
//        this.addView(settingsButton);
    ...
    void resizeButtons(int newwidth, int newheight) {
        int buttonheight = newheight / 2;
        int pad = buttonheight/10;

        stopButton.setPadding(pad, pad, pad, pad);
        playButton.setPadding(pad, pad, pad, pad);
        pauseButton.setPadding(pad, pad, pad, pad);
        settingsButton.setPadding(pad, pad, pad, pad);
        keyUpButton.setPadding(pad, pad, pad, pad);
        keyDownButton.setPadding(pad, pad, pad, pad);
        ...
        RelativeLayout.LayoutParams stopButtonParams;
        stopButtonParams = new RelativeLayout.LayoutParams(params);
        stopButtonParams.addRule(RelativeLayout.ALIGN_PARENT_TOP, RelativeLayout.TRUE);
        stopButtonParams.addRule(RelativeLayout.ALIGN_PARENT_LEFT, RelativeLayout.TRUE);
        stopButton.setLayoutParams(stopButtonParams);

        RelativeLayout.LayoutParams playButtonParams;
        playButtonParams = new RelativeLayout.LayoutParams(params);
        playButtonParams.addRule(RelativeLayout.RIGHT_OF, stopButton.getId());
        playButton.setLayoutParams(playButtonParams);

        RelativeLayout.LayoutParams pauseButtonParams;
        pauseButtonParams = new RelativeLayout.LayoutParams(params);
        pauseButtonParams.addRule(RelativeLayout.RIGHT_OF, playButton.getId());
        pauseButton.setLayoutParams(pauseButtonParams);

        RelativeLayout.LayoutParams keyDownButtonParams;
        keyDownButtonParams = new RelativeLayout.LayoutParams(params);
        keyDownButtonParams.addRule(RelativeLayout.RIGHT_OF, pauseButton.getId());
        keyDownButton.setLayoutParams(keyDownButtonParams);

        RelativeLayout.LayoutParams keyUpButtonParams;
        keyUpButtonParams = new RelativeLayout.LayoutParams(params);
        keyUpButtonParams.addRule(RelativeLayout.RIGHT_OF, keyDownButton.getId());
        keyUpButton.setLayoutParams(keyUpButtonParams);

        RelativeLayout.LayoutParams settingsButtonParams;
        settingsButtonParams = new RelativeLayout.LayoutParams(params);
//        settingsButtonParams.addRule(RelativeLayout.ALIGN_PARENT_TOP, RelativeLayout.TRUE);
//        settingsButtonParams.addRule(RelativeLayout.ALIGN_PARENT_RIGHT, RelativeLayout.TRUE);
        settingsButtonParams.addRule(RelativeLayout.ALIGN_PARENT_LEFT, RelativeLayout.TRUE);
        settingsButtonParams.addRule(RelativeLayout.BELOW, stopButton.getId());
        settingsButton.setLayoutParams(settingsButtonParams);


        RelativeLayout.LayoutParams keyTextParams;
        keyTextParams = new RelativeLayout.LayoutParams(LayoutParams.WRAP_CONTENT, buttonheight);
//        keyTextParams.addRule(RelativeLayout.ALIGN_PARENT_TOP, RelativeLayout.TRUE);
        keyTextParams.addRule(RelativeLayout.RIGHT_OF, keyUpButton.getId());
        keyTextParams.addRule(RelativeLayout.ALIGN_TOP, keyUpButton.getId());
//        keyTextParams.addRule(RelativeLayout.BELOW, pauseButton.getId());
        keyText.setLayoutParams(keyTextParams);

        RelativeLayout.LayoutParams speedBarParams;
        speedBarParams = new RelativeLayout.LayoutParams(buttonheight * 5/2, buttonheight*4/5);
        speedBarParams.addRule(RelativeLayout.BELOW, stopButton.getId());
//        speedBarParams.addRule(RelativeLayout.ALIGN_TOP, settingsButton.getId());
//        speedBarParams.addRule(RelativeLayout.ALIGN_RIGHT, settingsButton.getId());
        speedBarParams.addRule(RelativeLayout.ALIGN_PARENT_LEFT, RelativeLayout.TRUE);
        speedBar.setLayoutParams(speedBarParams);

        RelativeLayout.LayoutParams speedTextParams;
        speedTextParams = new RelativeLayout.LayoutParams(LayoutParams.WRAP_CONTENT, buttonheight);
        speedTextParams.addRule(RelativeLayout.BELOW, keyUpButton.getId());
        speedTextParams.addRule(RelativeLayout.RIGHT_OF, speedBar.getId());
        speedText.setLayoutParams(speedTextParams);

//        speedBarParams = new RelativeLayout.LayoutParams(speedBar.getLayoutParams());
//        keyTextParams.height = buttonheight;
//        keyTextParams.addRule(RelativeLayout.ALIGN_PARENT_LEFT, RelativeLayout.TRUE);
//        keyTextParams.addRule(RelativeLayout.ALIGN_PARENT_BOTTOM, RelativeLayout.TRUE);
//        keyText.setLayoutParams(keyTextParams);
...
/**
        ...
        keyUpButton.setLayoutParams(params);
        keyDownButton.setLayoutParams(params);
...
//        timer.post(DoPlay);
    ...
    /** The callback for transposing up. */
    public void KeyUp() {
        int pauseResume = 0;
        MidiOptions currentOptions = options.copy();

        if (currentOptions.transpose != 12) {
            if (playstate == playing) {
                pauseResume = 1;
                Pause();
                playstate = paused;
            ...
            currentOptions.transpose += 1;
//            keyText.setText("  Key: " + String.format(Locale.US, "%02d", currentOptions.transpose) + " ");
            if (currentOptions.transpose >= 0) {
                keyText.setText("  Key: " + String.format(Locale.US, "%+02d", currentOptions.transpose) + "  ");
            } else {
                keyText.setText("  Key: " + String.format(Locale.US, "%+02d", currentOptions.transpose) + "  ");
            }
            options.merge(currentOptions);
    ...
    /** The callback for transposing down. */
    public void KeyDown() {
        int pauseResume = 0;
        MidiOptions currentOptions = options.copy();
