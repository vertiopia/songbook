...
public class AToZActivity extends ListActivity implements TextWatcher {
    ...
    SongDBArrayAdapter<SongDBEntry> adapter;
...
//    }
    ...
    public void onCreate(Bundle state) {
        ...
        if (midiSonglist != null) {
            adapter = new SongDBArrayAdapter<SongDBEntry>(this, android.R.layout.simple_list_item_1, midiSonglist);
